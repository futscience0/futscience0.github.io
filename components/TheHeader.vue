<template>
  <nav :class="headerClassList" class="fixed w-full z-40 top-0" style = "background-color: #ffc722">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      ...
      <div class="block lg:hidden pr-4">
        <button
          class="flex items-center p-1 text-gray-900 hover:text-gray-900"
...
export default {
  ...
  computed: {
    ...
    navActionClassList() {
      return this.isSticky ? 'text-white' : 'bg-white text-gray-900'
    },
    navContentClassList() {
